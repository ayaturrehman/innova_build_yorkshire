                ...
                <div className="row">
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6">
                        <div className="team-one__single">
                            ...
                            <div className="team-one__content">
                                <h3 className="team-one__title"><Link href="team">Devid Lauis</Link></h3>
                                <p className="team-one__text">Marketing Ceo</p>
                                <div className="team-one__share-and-social">
                                    <div className="team-one__share">
                                        <Link href="#"><span className="icon-share"></span></Link>
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6">
                        <div className="team-one__single">
                            ...
                            <div className="team-one__content">
                                <h3 className="team-one__title"><Link href="team">Devid Moor</Link></h3>
                                <p className="team-one__text">Marketing Ceo</p>
                                <div className="team-one__share-and-social">
                                    <div className="team-one__share">
                                        <Link href="#"><span className="icon-share"></span></Link>
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6">
                        <div className="team-one__single">
                            ...
                            <div className="team-one__content">
                                <h3 className="team-one__title"><Link href="team">Stuart Law</Link></h3>
                                <p className="team-one__text">Marketing Ceo</p>
                                <div className="team-one__share-and-social">
                                    <div className="team-one__share">
                                        <Link href="#"><span className="icon-share"></span></Link>
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6">
                        <div className="team-one__single">
                            ...
                            <div className="team-one__content">
                                <h3 className="team-one__title"><Link href="team">Piter Moor</Link></h3>
                                <p className="team-one__text">Marketing Ceo</p>
                                <div className="team-one__share-and-social">
                                    <div className="team-one__share">
                                        <Link href="#"><span className="icon-share"></span></Link>
