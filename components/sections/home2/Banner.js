						...
						<div className="row">
							<div className="col-xl-12">
								<div className="main-slider-two__content">
									<p className="main-slider-two__sub-title">welcome to Echelon</p>
									<h2 className="main-slider-two__title">Building Dreams <br/> Brick at a Time</h2>
									...
									<div className="main-slider-two__btn-and-call-box">
										<div className="main-slider-two__btn-box">
											<Link href="about" className="main-slider-two__btn thm-btn">Read
